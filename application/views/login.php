...
<body>
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="/"><img alt="Brand" class="img-responsive" src="/uploads/shell-logo-small.jpg">Shell</a>
  </div>
...
<div class="intro-header" id="home">
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item">
        <img src="/uploads/1.jpg" alt="Casport 1">
      </div>
      <div class="item active">
        <img src="/uploads/2.jpg" alt="Casport 2">
      </div>
      <div class="item">
        <img src="/uploads/3.jpg" alt="Casport 3">
      </div>
      <div class="item">
        <img src="/uploads/4.jpg" alt="Casport 4">
      </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <p class="copyright text-muted small">Este sitio está optimizado para Internet Explorer 10 o superior, FireFox y Google Chrome</p>
                </div>
            </div>
        </div>
    </footer>
